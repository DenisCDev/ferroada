...
Mensagem se a ideia era «Ferroada na Vercel»: este processo precisa de uma VM. Use o modo `cdn-edge` com origin Vercel **sem** Ferroada, ou alugue uma VPS.
...
`/readyz` faria TCP contra a Vercel. Use `/healthz`.
