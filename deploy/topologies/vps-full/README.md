...
Ferroada + app na mesma Compose. Supabase self-host é opcional, na overlay. Sem painel Next em produção.

Não é um modo `init` — copie esta pasta ou, quando o subcomando existir, `ferroada init --topology vps-full`.
