...
Frontend e backend na mesma máquina. Público: 80/443 via mapa Docker no Ferroada, ou Caddy na frente.

Não é um modo `init` — copie esta pasta ou, quando o subcomando existir, `ferroada init --topology vps-site`.
