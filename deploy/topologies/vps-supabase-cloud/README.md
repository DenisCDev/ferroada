...
Ferroada frente ao BFF/app. O browser fala com *.supabase.co à parte, salvo a opção 2 (host dedicado).

Não é um modo `init` — copie esta pasta ou, quando o subcomando existir, `ferroada init --topology vps-supabase-cloud`.
